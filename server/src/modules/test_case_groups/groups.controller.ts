...
import {
  ...
  EditTestGroups,
  FullTreeWithGropusAndTestCasesForRun,
} from "./groups.service";

export async function EditTestGroupsController(
  req: AuthRequest,
  res: Response
) {
  try {
    ...
    if (!groupId) {
      return res
        .status(400)
        .json({ error: "GROUP ID ,NAME, DESCRIPTION is required" });
    }
...
export async function CreateTestGroupsController(
  req: AuthRequest,
  res: Response
) {
  try {
...
export async function DeleteGroupWithTestCasesController(
  req: AuthRequest,
  res: Response
) {
  try {
...
export async function DisplayAllTestCasesAndAssignedGroupsController(
  req: AuthRequest,
  res: Response
) {
  try {
...
export async function DisplayGroupTreeController(
  req: AuthRequest,
  res: Response
) {
  try {
...
export async function DisplayCountOfTestCasesInEachGroupController(
  req: AuthRequest,
  res: Response
) {
  try {
...
export async function DisplayCountOfTestCasesInProjectController(
  req: AuthRequest,
  res: Response
) {
  try {
...
export async function FullTreeWithGropusAndTestCasesController(
  req: AuthRequest,
  res: Response
) {
  try {
